        ...
        private void setButtonsOnBoard()
        {
            ...
            for (int i = 0; i < m_NumberOfRows; i++)
            {
                for (int j = 0; j < m_NumberOfColumns; j++)
                {
                    ...
                    m_CardsButtons[i, j].Left = this.Left + 8 + leftLocation;
                    if (i == 0)
                    {
                    ...
                    {
                        m_CardsButtons[i, j].Top = this.Top + BottomLocation + 10;
                    }

                    m_CardsButtons[i, j].Size = new System.Drawing.Size(50, 50);
